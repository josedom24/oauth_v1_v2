    ...
    <a href="http://laxmarcaellugar.blogspot.com.es/2011/08/el-protocolo-de-autenticacion-oauth_08.html">Flujo oauth1</a>
  	<ul>
        ...
        def twitter():
  		...
  		<li>Una vez que nos hemos autentificado de forma adecuada la aplicación (en este caso twitter) nos devuelve a la Callback URL (http://prjd.herokuapp.com/callback) donde cogemos un token de verificación que nos permitirá a continuación obtener los tokens de acceso (ACCESS_TOKEN,ACCESS_TOKEN_SECRET)</li>
      <pre>
       def get_access_token(TOKENS):
